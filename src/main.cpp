...
const char* defaultScene = "data/chess.trinity";
...
int main(int argc, char** argv)
{
	...
	pieces.insert(std::make_pair("black_pawn1", new Pawn(board.board[7][6], "black")));
	pieces["black_pawn2"] = new Pawn(board.board[6][6], "black");
	pieces["black_pawn3"] = new Pawn(board.board[5][6], "black");
	pieces["black_pawn4"] = new Pawn(board.board[4][6], "black");
	pieces["black_pawn5"] = new Pawn(board.board[3][6], "black");
	pieces["black_pawn6"] = new Pawn(board.board[2][6], "black");
	pieces["black_pawn7"] = new Pawn(board.board[1][6], "black");
	pieces["black_pawn8"] = new Pawn(board.board[0][6], "black");
	pieces["white_pawn1"] = new Pawn(board.board[7][1], "white");
	pieces["white_pawn2"] = new Pawn(board.board[6][1], "white");
	pieces["white_pawn3"] = new Pawn(board.board[5][1], "white");
	pieces["white_pawn4"] = new Pawn(board.board[4][1], "white");
	pieces["white_pawn5"] = new Pawn(board.board[3][1], "white");
	pieces["white_pawn6"] = new Pawn(board.board[2][1], "white");
	pieces["white_pawn7"] = new Pawn(board.board[1][1], "white");
	pieces["white_pawn8"] = new Pawn(board.board[0][1], "white");
	pieces["black_rook1"] = new Rook(board.board[7][7], "black");
	pieces["black_rook2"] = new Rook(board.board[0][7], "black");
	pieces["black_knight1"] = new Knight(board.board[6][7], "black");
	pieces["black_knight2"] = new Knight(board.board[1][7], "black");
	pieces["black_bishop1"] = new Bishop(board.board[5][7], "black");
	pieces["black_bishop2"] = new Bishop(board.board[2][7], "black");
	pieces["black_queen"] = new Queen(board.board[3][7], "black");
	pieces["black_king"] = new King(board.board[4][7], "black");
	pieces["white_rook1"] = new Rook(board.board[7][0], "white");
	pieces["white_rook2"] = new Rook(board.board[0][0], "white");
	pieces["white_knight1"] = new Knight(board.board[6][0], "white");
	pieces["white_knight2"] = new Knight(board.board[1][0], "white");
	pieces["white_bishop1"] = new Bishop(board.board[5][0], "white");
	pieces["white_bishop2"] = new Bishop(board.board[2][0], "white");
	pieces["white_queen"] = new Queen(board.board[3][0], "white");
	pieces["white_king"] = new King(board.board[4][0], "white");
